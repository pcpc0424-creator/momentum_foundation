  ...
  const features = [
    {
      ...
      title: t('meat.feature1.title'),
      description: t('meat.feature1.desc')
    },
    {
      icon: <Shield className="h-8 w-8 text-sage-green" />,
      title: t('meat.feature2.title'),
      description: t('meat.feature2.desc')
    },
    {
      icon: <Truck className="h-8 w-8 text-sage-green" />,
      title: t('meat.feature3.title'),
      description: t('meat.feature3.desc')
    }
  ];
